...
unsigned int nTargetSpacing = 1 * 60; // 1 minute blocks
unsigned int nStakeMinAge = 60 * 60 * 2; // 2 hours
unsigned int nStakeMaxAge = -1;           //unlimited
unsigned int nModifierInterval = 10 * 60; // time to elapse before new modifier is computed

int nCoinbaseMaturity = 45; //45 blocks for coins to mature gnome sayan
...
const string strMessageMagic = "kingdomcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "kingdomcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "kingdomcoin - born to be the king";
        CTransaction txNew;
        txNew.nTime = 1417523151;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xb0b5f0aecc4fd8df98524f11fc95a4d5f0de58c5b37cd5acc8e73ab1e45692b0"));
        //block.print();
