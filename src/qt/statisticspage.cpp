...
void StatisticsPage::updateStatistics()
{
    ...
    {
        subsidy = "0 kingdomcoin per block";
    }
    else if(pindexBest->nHeight < 4320)
    {
        subsidy = "125 kingdomcoin per block";
    }
    else if(pindexBest->nHeight < 8640)
    {
        subsidy = "105 kingdomcoin per block";
    }
    else if(pindexBest->nHeight < 12960)
    {
        subsidy = "80 kingdomcoin per block";
    }
    else if(pindexBest->nHeight < 17280)
    {
        subsidy = "55 kingdomcoin per block";
    }
    else if(pindexBest->nHeight < 20160)
    {
        subsidy = "35 kingdomcoin per block";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " KING" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " KING" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " KING");
    }
