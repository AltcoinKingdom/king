...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("kingdomcoin-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "kingdomcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"178.62.233.116", "178.62.233.116"}, //Main kingdomcoin Seed Node
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("kingdomcoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("kingdomcoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("kingdomcoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("kingdomcoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. kingdomcoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("kingdomcoin-start");
